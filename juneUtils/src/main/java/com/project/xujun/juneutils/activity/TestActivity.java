...
public class TestActivity extends AppCompatActivity {
    ...
    private VideoPlayView video_player;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        video_player = (VideoPlayView) findViewById(R.id.video_player);
        ...
        String url = "http://music.wufazhuce.com/li7nWHaLt0iHdDtUYrl-xJASqxZP";
        video_player.playVideo(url,"血亲关系");
    }
}
