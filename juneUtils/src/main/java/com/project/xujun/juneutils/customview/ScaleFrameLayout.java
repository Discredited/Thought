...
public class ScaleFrameLayout extends FrameLayout {
    ...
    public void setLayoutScale(int fix_mode, int width_scale, int height_scale) {
    ...
    public void init(Context context, AttributeSet attrs, int defStyleAttr) {
        if (null != attrs) {
            ...
            width_scale = a.getInt(R.styleable.ScaleFrameLayout_frame_width_scale, DEFAULT_WIDTH_SCALE);
            height_scale = a.getInt(R.styleable.ScaleFrameLayout_frame_height_scale, DEFAULT_HEIGHT_SCALE);
            fix_mode = a.getInt(R.styleable.ScaleFrameLayout_frame_fix_mode, DEFAULT_FIX_MODE);
            a.recycle();
        } else {
